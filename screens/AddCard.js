import {KeyboardAvoidingView, Platform, StyleSheet, View, TouchableOpacity, ImageBackground, Image, Text, Switch} from 'react-native';
  ...
  return(
    ...
    <View style={styles.container}>
      <KeyboardAvoidingView    behavior={Platform.OS === "ios" ? "padding" : "height"} style={{
        ...
        <TouchableOpacity onPress={() => printOutput()}>
            <ImageBackground
